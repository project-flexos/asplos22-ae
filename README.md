...
| [`fig-09`](/experiments/fig-09_iperf-throughput/)       | <img src="experiments/fig-09_iperf-throughput/fig-09_iperf-throughput.svg" width="200" />       | NW throughput (iPerf) with Unikraft (baseline), FlexOS w/o isolation, with 2 compartments backed by MPK (-_light_ = shared call stacks, -_dss_ = protected and DSS) and EPT.                                                                                                                                                    | 0h 45m               | 0h 0m             |
